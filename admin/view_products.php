                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">New Car Details</strong>
                        </div>
                        <div class="card-body">
                  <table id="bootstrap-data-table" class="table table-striped table-bordered">
                    ...
                    <tbody>
					 <?php
				                        require('../config.php');
			    	                    $a="SELECT * FROM product WHERE STATUS='added'";
				                        $b=mysql_query($a);
				                        while($row=mysql_fetch_array($b))
    				                    { 
									$string2 = substr($row['condition'], 0, 20)
                      ...
                      <tr>
						...
						<td>
						 ...
						 <?php
                                      ...
                                      ?>
                                  <a href="uphalld.php?c=<?php echo $row['pid'];?>"><img src="images/tog2.png" width="50" class="img-responsive" alt=""/></a>
