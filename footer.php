			...
			<div class="top">
				<div class="container">
					...
					<div class="row">
						<div class="col-sm-4">
							<h5>About Us</h5>
							<p>We are the leadind car auction company.we have best price and best service.</p>
							<hr />
							<div class="iconbox-left">
								<div class="icon"><i class="fa fa-map-marker"></i></div> <!-- end .icon -->
								<div class="content"><p>RoundEast,Thrissur,Thriprayar</p></div> <!-- end .content -->
							</div> <!-- end .iconbox-left -->
							<div class="iconbox-left">
								<div class="icon"><i class="fa fa-envelope"></i></div> <!-- end .icon -->
								<div class="content"><p>info@automart.com</p></div> <!-- end .content -->
							</div> <!-- end .iconbox-left -->
							<div class="iconbox-left">
								<div class="icon"><i class="fa fa-phone"></i></div> <!-- end .icon -->
								<div class="content"><p>9605902005</p></div> <!-- end .content -->
							</div> <!-- end .iconbox-left -->
						</div> <!-- end .col-sm-4 -->
						<div class="col-sm-4">
...
<!-- Mirrored from premiumlayers.net/demo/html/automan/contact-us.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 21 Nov 2018 09:15:19 GMT -->
</html>