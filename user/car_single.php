		...
		<section class="section white">
			<div class="inner">
				...
				<?php
					...
					//$base_ratess=$row2['bid_rate'];
					//$rate=$row2['a.bid_rate'];
					//echo $rate;
								...
								<div class="details-box">
									...
									<div class="content">
										...
										<?php
											...
											/*$biduser="no bid yet"
												$qrybid="select userid from bidding where aid='$aid' and amount='$currentbid'";
											$resbid=mysql_query($qrybid);
											while($rowbid=mysql_fetch_array($resbid))
											{ 
												$biduser=$rowbid[0];
											}
											*/
										...
										{
											?>
											<font color="red" size="4"><p> Auction Expired...!</p></font>
											<?php
										}
										?>
...
if(isset($_POST['btnbid']))
{
	...
	$bid_amount=$currentbid+$rate;
	$user=$_SESSION["user"];
	$r="insert into bidding values(NULL,'$user','$aid','$bid_amount','$dnow')";
	$v=mysql_query($r);
	...
	header('Location: car_single.php?aid='.$aid);
