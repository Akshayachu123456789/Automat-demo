			...
			<div class="inner">
				<div class="container">
					<div id="team-slider" class="owl-carousel team-slider">
						...
						<div class="item">
							<div class="team-member" style="background-image: url('images/team02.jpg');">
								<div class="about">
									<span class="name">John Smith</span><span class="title">Selling Team Head</span>
									<div class="social-icons">
										<a href="#"><i class="fa fa-google-plus"></i></a>
						...
						<div class="item">
							<div class="team-member" style="background-image: url('images/team03.jpg');">
								<div class="about">
									<span class="name">John Smith</span><span class="title">Selling Team Head</span>
									<div class="social-icons">
										<a href="#"><i class="fa fa-google-plus"></i></a>
						...
						<div class="item">
							<div class="team-member" style="background-image: url('images/team04.jpg');">
								<div class="about">
									<span class="name">John Smith</span><span class="title">Selling Team Head</span>
									<div class="social-icons">
										<a href="#"><i class="fa fa-google-plus"></i></a>
