<?php
	...
	?>
		...
		<div class="page-title" style="background-image: url('images/background01.jpg');">
			<div class="inner">
				<div class="container">
					<div class="title">Available Auction Listing</div> <!-- end .title -->
				</div> <!-- end .container -->
			</div> <!-- end .inner -->
		</div> <!-- end .page-title -->
		...
		<section class="section small-top-padding white">
			<div class="inner">
				<div class="container">
					...
					$qry1="select p.pid,p.name,p.category,p.manufature,p.fuel,p.color,p.condition,p.image1,a.base_price,a.aid from product p JOIN auction a on p.pid = a.pid where a.status='auction' ORDER by a.aid";
